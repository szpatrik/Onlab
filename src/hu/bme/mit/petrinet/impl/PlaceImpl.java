 ...
 * <ul>
 *   <li>{@link hu.bme.mit.petrinet.impl.PlaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link hu.bme.mit.petrinet.impl.PlaceImpl#getToken <em>Token</em>}</li>
 *   <li>{@link hu.bme.mit.petrinet.impl.PlaceImpl#getOutgoing <em>Outgoing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends MinimalEObjectImpl.Container implements Place {
	 ...
	 * @ordered
	 */
	protected EList<PTArc> outgoing;
	 ...
	 * @generated
	 */
	public EList<PTArc> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectContainmentWithInverseEList<PTArc>(PTArc.class, this, PetrinetPackage.PLACE__OUTGOING, PetrinetPackage.PT_ARC__SOURCE);
		}
		return outgoing;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PetrinetPackage.PLACE__OUTGOING:
				getOutgoing().clear();
				getOutgoing().addAll((Collection<? extends PTArc>)newValue);
				return;
		}
